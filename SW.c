...
/* SW_Update period */
#define SW_PERIOD_MS   (20) // must be greater than bouncing time
...
void SW_Init(void)
{
    ...
    /* Add your code here! */
    /* 1.Initialize corresponding PB GPIO pin as input
       2.Set PB state and set corresponding PB samples corresponding
    */
    // Initialize H.W
...
void SW_Update(void)
{
    /*  1.check its period has come
        2.take new sample for PB
        3.change state of PB based on the last samples
    */
    /************************* number one ****************************/
