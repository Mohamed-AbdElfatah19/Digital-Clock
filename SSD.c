...
static tByte SSD_Data[N_SSD_SYMBOLS] = // LUT
{
    0b00111111,
    0b00000110,
    0b01011011,
...
/* SSD values */
static tSSD_Symbol SSD_Values[N_SSD] = {SSD_NULL}; // Buffer

static tByte SSD_DotState = SSD_OFF;

// دي معظم اللوجيك بتاع ال update
...
void SSD_Init(tSSD ssd)
{
    ...
    /* Initialize SSD control pin(state pin ) and turn SSD OFF*/
    switch (ssd)
    {
